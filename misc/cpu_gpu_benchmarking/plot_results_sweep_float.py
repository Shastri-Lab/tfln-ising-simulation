...
if __name__ == "__main__":
    ...
    name_map = {
        'CPU: M2 Max (Naive MVM)': 'bench_cpu_ref_float',
        'CPU: M2 Max (Accelerate BLAS)': 'bench_cpu_blas_float',
        'CPU: M2 Max (Numpy OpenBLAS)': 'bench_cpu_numpy_float',
        'GPU: M2 Max (Metal Performance Shaders)': 'bench_cpu_mps_float',
