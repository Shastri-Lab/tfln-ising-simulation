...
// matrix-vector multiplication (sgemv) using single precision floating-point numbers.
...
clang -O3 \                             # Optimization level 3 for maximum speed    
      ...
      -o libcpu_blas_float.so cpu_blas_float.c      # Output shared library name
*/
...
void sgemv_blas(const float *A, const float *x,
