...
* Description: Vitis code to give input of Model without decision and sieve
* 
* Dependencies: 
* 
* Revision:
...
int main() {
    ...
    while (1) {
    	...
    	if(data == WRITE){
    		...
    		scanf("%d",&data);
    		Xil_Out32((XPAR_AXI_WITHOUT_DECISION_0_BASEADDR) + (reg_num*AXI_DATA_BYTE), (u32)(data));
    	...
    	//read operate
    		...
    		scanf("%d",&reg_num);
    		data = Xil_In32((XPAR_AXI_WITHOUT_DECISION_0_BASEADDR) + (reg_num*AXI_DATA_BYTE));
