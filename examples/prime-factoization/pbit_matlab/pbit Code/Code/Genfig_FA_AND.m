...
% Compute the values
val = 2*(2*(2*(2*(2*(2*m1_in1 + m2_in2) + m3_in3) + m4_in4) + m5_in5)+m6_out1)+m7_out2;

% Count the occurrences of each value from 0 to 31
aa = histc(val, 0:127);

% Generate the labels as decimal values
lbl = categorical(string(0:127));
...
val = 2*(2*(2*(2*m1_in1 + m2_in2) + m3_in3) + m4_in4) + m5_in5;
aa=histc(val,0:31);
